...
public class NetworkCamera : MonoBehaviour
{
	...
	public static NetworkCamera singleton; //You can call CameraManager.singleton from other script (There can be only one)
	...
	public void GetPlayer(Transform _target){
		target = _target;
	}
